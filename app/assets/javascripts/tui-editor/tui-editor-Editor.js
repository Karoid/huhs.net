          ...
          value: function _pasteToTable($clipboardContainer) {
            ...
            if (pastingToTable) {
              if (containsOneTableOnly) {
                ...
                alert(_i18n2.default.get('Cannot paste values â€‹â€‹other than a table in the cell selection state'));
 ...
 *     }} selectionInformation start, end column index and boolean value for whether range divided or not
    ...
    /***/ (function(module, exports, __webpack_require__) {
      ...
      _i18n2.default.setLanguage(['en', 'en_US'], {
        ...
        'Cannot paste values â€‹â€‹other than a table in the cell selection state': 'Cannot paste values â€‹â€‹other than a table in the cell selection state.',
    ...
    /***/ (function(module, exports, __webpack_require__) {
      ...
      _i18n2.default.setLanguage(['ko', 'ko_KR'], {
        ...
        'Ordered list': 'ë²ˆí˜¸ ë§¤ê¸°ê¸°',
        'Task': 'ì²´í¬ë°•ìŠ¤',
        'Indent': 'ë“¤ì—¬ì“°ê¸°',
        'Outdent': 'ë‚´ì–´ì“°ê¸°',
        'Insert link': 'ë§í¬ ì‚½ìž…',
        'Insert CodeBlock': 'ì½”ë“œë¸”ëŸ­ ì‚½ìž…',
        'Insert table': 'í‘œ ì‚½ìž…',
        'Insert image': 'ì´ë¯¸ì§€ ì‚½ìž…',
        'Heading': 'ì œëª©',
        'Image URL': 'ì´ë¯¸ì§€ ì£¼ì†Œ',
        'Select image file': 'ì´ë¯¸ì§€ íŒŒì¼ì„ ì„ íƒí•˜ì„¸ìš”.',
        'Description': 'ì„¤ëª…',
        'OK': 'í™•ì¸',
        'More': 'ë” ë³´ê¸°',
        'Cancel': 'ì·¨ì†Œ',
        ...
        'Remove table': 'í‘œ ì‚­ì œ',
        'Would you like to paste as table?': 'í‘œí˜•íƒœë¡œ ë¶™ì—¬ ë„£ê² ìŠµë‹ˆê¹Œ?',
        'Text color': 'ê¸€ìž ìƒ‰ìƒ',
        'Auto scroll enabled': 'ìžë™ ìŠ¤í¬ë¡¤ ì¼œì§',
        'Auto scroll disabled': 'ìžë™ ìŠ¤í¬ë¡¤ êº¼ì§',
        'Cannot paste values â€‹â€‹other than a table in the cell selection state.': 'ì…€ ì„ íƒ ìƒíƒœì—ì„œëŠ” í…Œì´ë¸” ì´ì™¸ì˜ ê°’ì€ ë¶™ì—¬ë„£ì„ ìˆ˜ ì—†ìŠµë‹ˆë‹¤.',
    ...
    /***/ (function(module, exports, __webpack_require__) {
      ...
      _i18n2.default.setLanguage(['zh', 'zh_CN'], {
        ...
        'Heading': 'æ ‡é¢˜',
        'Image URL': 'å›¾ç‰‡ç½‘å€',
        'Select image file': 'é€‰æ‹©æ˜ åƒæ–‡ä»¶',
        'Description': 'è¯´æ˜Ž',
        'OK': 'ç¡®è®¤',
        'More': 'æ›´å¤š',
        'Cancel': 'å–æ¶ˆ',
        ...
        'Align right': 'å³å¯¹é½',
        'Remove table': 'åˆ é™¤è¡¨',
        'Would you like to paste as table?': 'ä½ æƒ³ç²˜è´´è¡¨å—?',
        'Text color': 'æ–‡å­—è‰²ç›¸',
        'Auto scroll enabled': 'è‡ªåŠ¨æ»šåŠ¨å¯ç”¨',
        'Auto scroll disabled': 'è‡ªåŠ¨çš„æ»šåŠ¨ä½œéžä½¿ç”¨',
        'Cannot paste values â€‹â€‹other than a table in the cell selection state': 'åœ¨å•å…ƒæ ¼é€‰æ‹©çŠ¶æ€ä¸‹æ— æ³•ç²˜è´´è¡¨æ ¼ä»¥å¤–çš„å€¼ã€‚',
    ...
    /***/ (function(module, exports, __webpack_require__) {
      ...
      _i18n2.default.setLanguage(['ja', 'ja_JP'], {
        ...
        'Line': 'ãƒ©ã‚¤ãƒ³',
        'Blockquote': 'å¼•ç”¨',
        'Unordered list': 'ç•ªå·ãªã—ãƒªã‚¹ãƒˆ',
        'Ordered list': 'é †åºä»˜ããƒªã‚¹ãƒˆ',
        'Task': 'ã‚¿ã‚¹ã‚¯',
        'Indent': 'ã‚¤ãƒ³ãƒ‡ãƒ³ãƒˆ',
        'Outdent': 'ã‚¢ã‚¦ãƒˆãƒ‡ãƒ³ãƒˆ',
        'Insert link': 'ãƒªãƒ³ã‚¯æŒ¿å…¥',
        'Insert CodeBlock': 'ã‚³ãƒ¼ãƒ‰ãƒ–ãƒ­ãƒƒã‚¯æŒ¿å…¥',
        'Insert table': 'ãƒ†ãƒ¼ãƒ–ãƒ«æŒ¿å…¥',
        'Insert image': 'ç”»åƒæŒ¿å…¥',
        'Heading': 'è¦‹å‡ºã—',
        'Image URL': 'ã‚¤ãƒ¡ãƒ¼ã‚¸URL',
        'Select image file': 'ç”»åƒãƒ•ã‚¡ã‚¤ãƒ«é¸æŠž',
        ...
        'File': 'ãƒ•ã‚¡ã‚¤ãƒ«',
        'URL': 'URL',
        'Link text': 'ãƒªãƒ³ã‚¯ãƒ†ã‚­ã‚¹ãƒˆ',
        'Add row': 'è¡Œè¿½åŠ ',
        'Add col': 'åˆ—è¿½åŠ ',
        'Remove row': 'è¡Œå‰Šé™¤',
        'Remove col': 'åˆ—å‰Šé™¤',
        'Align left': 'å·¦æƒãˆ',
        'Align center': 'ä¸­å¤®æƒãˆ',
        'Align right': 'å³æƒãˆ',
        'Remove table': 'ãƒ†ãƒ¼ãƒ–ãƒ«å‰Šé™¤',
        'Would you like to paste as table?': 'ãƒ†ãƒ¼ãƒ–ãƒ«ã‚’è²¼ã‚Šä»˜ã‘ã¾ã™ã‹?',
        'Text color': 'æ–‡å­—è‰²ç›¸',
        'Auto scroll enabled': 'è‡ªå‹•ã‚¹ã‚¯ãƒ­ãƒ¼ãƒ«ãŒæœ‰åŠ¹',
        'Auto scroll disabled': 'è‡ªå‹•ã‚¹ã‚¯ãƒ­ãƒ¼ãƒ«ã‚’ç„¡åŠ¹ã«',
        'Cannot paste values â€‹â€‹other than a table in the cell selection state': 'è¡¨ä»¥å¤–ã®å€¤ã‚’ã‚»ãƒ«é¸æŠžçŠ¶æ…‹ã«è²¼ã‚Šä»˜ã‘ã‚‹ã“ã¨ã¯ã§ãã¾ã›ã‚“ã€‚',
        'Choose language': 'è¨€èªžé¸æŠž'
      }); /**
    ...
    /***/ (function(module, exports, __webpack_require__) {
      ...
      _i18n2.default.setLanguage(['nl', 'nl_NL'], {
        ...
        'Cannot paste values â€‹â€‹other than a table in the cell selection state': 'Kan geen waardes anders dan de tabel in de cell plakken',
    ...
    /***/ (function(module, exports, __webpack_require__) {
      ...
      _i18n2.default.setLanguage(['es', 'es_ES'], {
        ...
        'Insert CodeBlock': 'Insertar bloque de cÃ³digo',
        ...
        'Would you like to paste as table?': 'Â¿Desea pegar como tabla?',
        'Text color': 'Color del texto',
        'Auto scroll enabled': 'Desplazamiento automÃ¡tico habilitado',
        'Auto scroll disabled': 'Desplazamiento automÃ¡tico deshabilitado',
        'Cannot paste values â€‹â€‹other than a table in the cell selection state': 'SÃ³lo se pueden pegar tablas en el modo de selecciÃ³n de celdas',
    ...
    /***/ (function(module, exports, __webpack_require__) {
      ...
      _i18n2.default.setLanguage(['de', 'de_DE'], {
        ...
        'Unordered list': 'AufzÃ¤hlung',
        'Ordered list': 'Nummerierte AufzÃ¤hlung',
        'Task': 'Aufgabe',
        'Indent': 'inspringen',
        'Outdent': 'Uithangen',
        'Insert link': 'Link einfÃ¼gen',
        'Insert CodeBlock': 'Codeblock einfÃ¼gen',
        'Insert table': 'Tabelle einfÃ¼gen',
        'Insert image': 'Grafik einfÃ¼gen',
        'Heading': 'Titel',
        'Image URL': 'Bild URL',
        'Select image file': 'Grafik auswÃ¤hlen',
        ...
        'Would you like to paste as table?': 'MÃ¶chten Sie eine Tabelle einfÃ¼gen?',
        'Text color': 'Textfarbe',
        'Auto scroll enabled': 'Autoscrollen aktiviert',
        'Auto scroll disabled': 'Autoscrollen deaktiviert',
        'Cannot paste values â€‹â€‹other than a table in the cell selection state': 'Im Zellenauswahlstatus kÃ¶nnen keine anderen Werte als eine Tabelle eingefÃ¼gt werden',
    ...
    /***/ (function(module, exports, __webpack_require__) {
      ...
      _i18n2.default.setLanguage(['ru', 'ru_RU'], {
        'Markdown': 'Markdown',
        'WYSIWYG': 'WYSIWYG',
        'Write': 'ÐÐ°Ð¿Ð¸ÑÐ°Ñ‚ÑŒ',
        'Preview': 'ÐŸÑ€ÐµÐ´Ð²Ð°Ñ€Ð¸Ñ‚ÐµÐ»ÑŒÐ½Ñ‹Ð¹ Ð¿Ñ€Ð¾ÑÐ¼Ð¾Ñ‚Ñ€',
        'Headings': 'Ð—Ð°Ð³Ð¾Ð»Ð¾Ð²ÐºÐ¸',
        'Paragraph': 'ÐÐ±Ð·Ð°Ñ†',
        'Bold': 'Ð–Ð¸Ñ€Ð½Ñ‹Ð¹',
        'Italic': 'ÐšÑƒÑ€ÑÐ¸Ð²',
        'Strike': 'Ð—Ð°Ñ‡ÐµÑ€ÐºÐ½ÑƒÑ‚Ñ‹Ð¹',
        'Code': 'Ð’ÑÑ‚Ñ€Ð¾ÐµÐ½Ð½Ñ‹Ð¹ ÐºÐ¾Ð´',
        'Line': 'Ð¡Ñ‚Ñ€Ð¾ÐºÐ°',
        'Blockquote': 'Ð‘Ð»Ð¾Ðº Ñ†Ð¸Ñ‚Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ñ',
        'Unordered list': 'ÐÐµÑƒÐ¿Ð¾Ñ€ÑÐ´Ð¾Ñ‡ÐµÐ½Ð½Ñ‹Ð¹ ÑÐ¿Ð¸ÑÐ¾Ðº',
        'Ordered list': 'Ð£Ð¿Ð¾Ñ€ÑÐ´Ð¾Ñ‡ÐµÐ½Ð½Ñ‹Ð¹ ÑÐ¿Ð¸ÑÐ¾Ðº',
        'Task': 'Ð—Ð°Ð´Ð°Ñ‡Ð°',
        'Indent': 'Ð¾Ñ‚ÑÑ‚ÑƒÐ¿',
        'Outdent': 'Ð’Ñ‹ÑÑ‚ÑƒÐ¿',
        'Insert link': 'Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ ÑÑÑ‹Ð»ÐºÑƒ',
        'Insert CodeBlock': 'Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ ÐºÐ¾Ð´',
        'Insert table': 'Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ Ñ‚Ð°Ð±Ð»Ð¸Ñ†Ñƒ',
        'Insert image': 'Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ðµ',
        'Heading': 'Ð—Ð°Ð³Ð¾Ð»Ð¾Ð²Ð¾Ðº',
        'Image URL': 'URL Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ñ',
        'Select image file': 'Ð’Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ Ñ„Ð°Ð¹Ð» Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ñ',
        ...
        'File': 'Ð¤Ð°Ð¹Ð»',
        'URL': 'URL',
        'Link text': 'Ð¢ÐµÐºÑÑ‚ ÑÑÑ‹Ð»ÐºÐ¸',
        'Add row': 'Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ Ñ€ÑÐ´',
        'Add col': 'Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ ÑÑ‚Ð¾Ð»Ð±ÐµÑ†',
        'Remove row': 'Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ Ñ€ÑÐ´',
        'Remove col': 'Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ ÑÑ‚Ð¾Ð»Ð±ÐµÑ†',
        'Align left': 'Ð’Ñ‹Ñ€Ð¾Ð²Ð½ÑÑ‚ÑŒ Ð¿Ð¾ Ð»ÐµÐ²Ð¾Ð¼Ñƒ ÐºÑ€Ð°ÑŽ',
        'Align center': 'Ð’Ñ‹Ñ€Ð¾Ð²Ð½ÑÑ‚ÑŒ Ð¿Ð¾ Ñ†ÐµÐ½Ñ‚Ñ€Ñƒ',
        'Align right': 'Ð’Ñ‹Ñ€Ð¾Ð²Ð½ÑÑ‚ÑŒ Ð¿Ð¾ Ð¿Ñ€Ð°Ð²Ð¾Ð¼Ñƒ ÐºÑ€Ð°ÑŽ',
        'Remove table': 'Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ Ñ‚Ð°Ð±Ð»Ð¸Ñ†Ñƒ',
        'Would you like to paste as table?': 'Ð’Ñ‹ Ñ…Ð¾Ñ‚Ð¸Ñ‚Ðµ Ð²ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ Ð² Ð²Ð¸Ð´Ðµ Ñ‚Ð°Ð±Ð»Ð¸Ñ†Ñ‹?',
        'Text color': 'Ð¦Ð²ÐµÑ‚ Ñ‚ÐµÐºÑÑ‚Ð°',
        'Auto scroll enabled': 'ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡ÐµÑÐºÐ°Ñ Ð¿Ñ€Ð¾ÐºÑ€ÑƒÑ‚ÐºÐ° Ð²ÐºÐ»ÑŽÑ‡ÐµÐ½Ð°',
        'Auto scroll disabled': 'ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡ÐµÑÐºÐ°Ñ Ð¿Ñ€Ð¾ÐºÑ€ÑƒÑ‚ÐºÐ° Ð¾Ñ‚ÐºÐ»ÑŽÑ‡ÐµÐ½Ð°',
        'Cannot paste values â€‹â€‹other than a table in the cell selection state': 'Ð’Ñ‹ Ð½Ðµ Ð¼Ð¾Ð¶ÐµÑ‚Ðµ Ð²ÑÑ‚Ð°Ð²Ð»ÑÑ‚ÑŒ Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ñ, Ð¾Ñ‚Ð»Ð¸Ñ‡Ð½Ñ‹Ðµ Ð¾Ñ‚ Ñ‚Ð°Ð±Ð»Ð¸Ñ†Ñ‹, Ð² ÑÐ¾ÑÑ‚Ð¾ÑÐ½Ð¸Ð¸ Ð²Ñ‹Ð±Ð¾Ñ€Ð° ÑÑ‡ÐµÐ¹ÐºÐ¸.',
        'Choose language': 'Ð’Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ ÑÐ·Ñ‹Ðº'
      }); /**
    ...
    /***/ (function(module, exports, __webpack_require__) {
      ...
      _i18n2.default.setLanguage(['fr', 'fr_FR'], {
        ...
        'Line': 'Ligne',
        'Blockquote': 'Citation',
        'Unordered list': 'Liste non-ordonnÃ©e',
        'Ordered list': 'Liste ordonnÃ©e',
        'Task': 'TÃ¢che',
        'Indent': 'Retrait',
        'Outdent': 'Sortir',
        'Insert link': 'InsÃ©rer un lien',
        'Insert CodeBlock': 'InsÃ©rer un bloc de code',
        'Insert table': 'InsÃ©rer un tableau',
        'Insert image': 'InsÃ©rer une image',
        'Heading': 'En-tÃªte',
        'Image URL': 'URL de l\'image',
        'Select image file': 'SÃ©lectionnez un fichier image',
        'Description': 'Description',
        'OK': 'OK',
        'More': 'de plus',
        'Cancel': 'Annuler',
        ...
        'Auto scroll enabled': 'DÃ©filement automatique activÃ©',
        'Auto scroll disabled': 'DÃ©filement automatique dÃ©sactivÃ©',
        'Cannot paste values â€‹â€‹other than a table in the cell selection state': 'Impossible de coller autre chose qu\'un tableau dans la sÃ©lection de la cellule.',
    ...
    /***/ (function(module, exports, __webpack_require__) {
      ...
      _i18n2.default.setLanguage(['uk', 'uk_UA'], {
        'Markdown': 'Markdown',
        'WYSIWYG': 'WYSIWYG',
        'Write': 'ÐÐ°Ð¿Ð¸ÑÐ°Ñ‚Ð¸',
        'Preview': 'ÐŸÐ¾Ð¿ÐµÑ€ÐµÐ´Ð½Ñ–Ð¹ Ð¿ÐµÑ€ÐµÐ³Ð»ÑÐ´',
        'Headings': 'Ð—Ð°Ð³Ð¾Ð»Ð¾Ð²ÐºÐ¸',
        'Paragraph': 'ÐÐ±Ð·Ð°Ñ†',
        'Bold': 'Ð–Ð¸Ñ€Ð½Ð¸Ð¹',
        'Italic': 'ÐšÑƒÑ€ÑÐ¸Ð²',
        'Strike': 'Ð—Ð°ÐºÑ€ÐµÑÐ»ÐµÐ½Ð¸Ð¹',
        'Code': 'Ð’Ð±ÑƒÐ´Ð¾Ð²Ð°Ð½Ð¸Ð¹ ÐºÐ¾Ð´',
        'Line': 'Ð›Ñ–Ð½Ñ–Ñ',
        'Blockquote': 'Ð‘Ð»Ð¾Ðº Ñ†Ð¸Ñ‚ÑƒÐ²Ð°Ð½Ð½Ñ',
        'Unordered list': 'ÐÐµÐ²Ð¿Ð¾Ñ€ÑÐ´ÐºÐ¾Ð²Ð°Ð½Ð¸Ð¹ ÑÐ¿Ð¸ÑÐ¾Ðº',
        'Ordered list': 'Ð£Ð¿Ð¾Ñ€ÑÐ´ÐºÐ¾Ð²Ð°Ð½Ð¸Ð¹ ÑÐ¿Ð¸ÑÐ¾Ðº',
        'Task': 'Ð—Ð°Ð²Ð´Ð°Ð½Ð½Ñ',
        'Indent': 'Ð²Ñ–Ð´ÑÑ‚ÑƒÐ¿',
        'Outdent': 'Ð·Ð°ÑÑ‚Ð°Ñ€Ñ–Ð»Ð¸Ð¹',
        'Insert link': 'Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ð¿Ð¾ÑÐ¸Ð»Ð°Ð½Ð½Ñ',
        'Insert CodeBlock': 'Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ ÐºÐ¾Ð´',
        'Insert table': 'Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ñ‚Ð°Ð±Ð»Ð¸Ñ†ÑŽ',
        'Insert image': 'Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð½Ñ',
        'Heading': 'Ð—Ð°Ð³Ð¾Ð»Ð¾Ð²Ð¾Ðº',
        'Image URL': 'URL Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð½Ñ',
        'Select image file': 'Ð’Ð¸Ð±Ñ€Ð°Ñ‚Ð¸ Ñ„Ð°Ð¹Ð» Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð½Ñ',
        'Description': 'ÐžÐ¿Ð¸Ñ',
        'OK': 'OK',
        'More': 'Ñ‰Ðµ',
        ...
        'File': 'Ð¤Ð°Ð¹Ð»',
        'URL': 'URL',
        'Link text': 'Ð¢ÐµÐºÑÑ‚ Ð¿Ð¾ÑÐ¸Ð»Ð°Ð½Ð½Ñ',
        'Add row': 'Ð”Ð¾Ð´Ð°Ñ‚Ð¸ Ñ€ÑÐ´',
        'Add col': 'Ð”Ð¾Ð´Ð°Ñ‚Ð¸ ÑÑ‚Ð¾Ð²Ð¿Ñ‡Ð¸Ðº',
        'Remove row': 'Ð’Ð¸Ð´Ð°Ð»Ð¸Ñ‚Ð¸ Ñ€ÑÐ´',
        'Remove col': 'Ð’Ð¸Ð´Ð°Ð»Ð¸Ñ‚Ð¸ ÑÑ‚Ð¾Ð²Ð¿Ñ‡Ð¸Ðº',
        'Align left': 'Ð’Ð¸Ñ€Ñ–Ð²Ð½ÑÑ‚Ð¸ Ð¿Ð¾ Ð»Ñ–Ð²Ð¾Ð¼Ñƒ ÐºÑ€Ð°ÑŽ',
        'Align center': 'Ð’Ð¸Ñ€Ñ–Ð²Ð½ÑÑ‚Ð¸ Ð¿Ð¾ Ñ†ÐµÐ½Ñ‚Ñ€Ñƒ',
        'Align right': 'Ð’Ð¸Ñ€Ñ–Ð²Ð½ÑÑ‚Ð¸ Ð¿Ð¾ Ð¿Ñ€Ð°Ð²Ð¾Ð¼Ñƒ ÐºÑ€Ð°ÑŽ',
        'Remove table': 'Ð’Ð¸Ð´Ð°Ð»Ð¸Ñ‚Ð¸ Ñ‚Ð°Ð±Ð»Ð¸Ñ†ÑŽ',
        'Would you like to paste as table?': 'Ð’Ð¸ Ñ…Ð¾Ñ‡ÐµÑ‚Ðµ Ð²ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ñƒ Ð²Ð¸Ð³Ð»ÑÐ´Ñ– Ñ‚Ð°Ð±Ð»Ð¸Ñ†Ñ–?',
        'Text color': 'ÐšÐ¾Ð»Ñ–Ñ€ Ñ‚ÐµÐºÑÑ‚Ñƒ',
        'Auto scroll enabled': 'ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡Ð½Ð° Ð¿Ñ€Ð¾ÐºÑ€ÑƒÑ‚ÐºÐ° Ð²ÐºÐ»ÑŽÑ‡ÐµÐ½Ð°',
        'Auto scroll disabled': 'ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡Ð½Ð° Ð¿Ñ€Ð¾ÐºÑ€ÑƒÑ‚ÐºÐ° Ð²Ñ–Ð´ÐºÐ»ÑŽÑ‡ÐµÐ½Ð°',
        'Cannot paste values â€‹â€‹other than a table in the cell selection state': 'Ð’Ð¸ Ð½Ðµ Ð¼Ð¾Ð¶ÐµÑ‚Ðµ Ð²ÑÑ‚Ð°Ð²Ð»ÑÑ‚Ð¸ Ð·Ð½Ð°Ñ‡ÐµÐ½Ð½Ñ, Ð²Ñ–Ð´Ð¼Ñ–Ð½Ð½Ñ– Ð²Ñ–Ð´ Ñ‚Ð°Ð±Ð»Ð¸Ñ†Ñ–, Ð² ÑÑ‚Ð°Ð½Ñ– Ð²Ð¸Ð±Ð¾Ñ€Ñƒ ÐºÐ¾Ð¼Ñ–Ñ€ÐºÐ¸.',
        'Choose language': 'Ð’Ð¸Ð±Ñ€Ð°Ñ‚Ð¸ Ð¼Ð¾Ð²Ñƒ'
      }); /**
    ...
    /***/ (function(module, exports, __webpack_require__) {
      ...
      _i18n2.default.setLanguage(['tr', 'tr_TR'], {
        ...
        'Bold': 'KalÄ±n',
        'Italic': 'Ä°talik',
        'Strike': 'AltÄ± Ã§izgili',
        'Code': 'SatÄ±r iÃ§i kod',
        'Line': 'Ã‡izgi',
        'Blockquote': 'AlÄ±ntÄ±',
        'Unordered list': 'SÄ±ralanmamÄ±ÅŸ liste',
        'Ordered list': 'SÄ±ralÄ± liste',
        'Task': 'GÃ¶rev kutusu',
        'Indent': 'Girintiyi arttÄ±r',
        'Outdent': 'Girintiyi azalt',
        'Insert link': 'BaÄŸlantÄ± ekle',
        'Insert CodeBlock': 'Kod bloku ekle',
        'Insert table': 'Tablo ekle',
        'Insert image': 'Ä°maj ekle',
        'Heading': 'BaÅŸlÄ±k',
        'Image URL': 'Ä°maj URL',
        'Select image file': 'Ä°maj dosyasÄ± seÃ§',
        ...
        'File': 'Dosya',
        'URL': 'URL',
        'Link text': 'BaÄŸlantÄ± yazÄ±sÄ±',
        'Add row': 'SatÄ±r ekle',
        'Add col': 'SÃ¼tun ekle',
        'Remove row': 'SatÄ±r sil',
        'Remove col': 'SÃ¼tun sil',
        'Align left': 'Sola hizala',
        'Align center': 'Merkeze hizala',
        'Align right': 'SaÄŸa hizala',
        'Remove table': 'Tabloyu kaldÄ±r',
        'Would you like to paste as table?': 'Tablo olarak yapÄ±ÅŸtÄ±rmak ister misiniz?',
        'Text color': 'Metin rengi',
        'Auto scroll enabled': 'Otomatik kaydÄ±rma aÃ§Ä±k',
        'Auto scroll disabled': 'Otomatik kaydÄ±rma kapalÄ±',
        'Cannot paste values â€‹â€‹other than a table in the cell selection state': 'HÃ¼cre seÃ§imi sÄ±rasÄ±nda tablo dÄ±ÅŸÄ±nda veriler yapÄ±ÅŸtÄ±rÄ±lamaz.',
        'Choose language': 'Dil seÃ§iniz'
      }); /**
       * @fileoverview I18N for Turkish
       * @author Mesut GÃ¶lcÃ¼k <mesutgolcuk@gmail.com>
       */
